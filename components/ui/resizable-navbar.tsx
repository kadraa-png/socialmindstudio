    ...
    >
      {items.map((item, idx) => (
        <a
          ...
          onClick={onItemClick}
          className="pointer-events-auto relative px-4 py-2 text-neutral-600 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 dark:text-neutral-300"
          key={`link-${idx}`}
          href={item.link}
        >
          {hovered === idx && (
